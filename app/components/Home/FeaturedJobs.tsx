...
const FeaturedJobs = () => {
  return (
    <div className='pt-20 pb-12'>
      <Heading mainHeading='Featured Jobs' subHeading='Elevate Your Career with Our Featured Listings'
      />
      <div className='mt-12 w-[80%] mx-auto grid grid-col-1 lg:grid-cols-2 gap-12'>
        {JobData.map((job) => {
